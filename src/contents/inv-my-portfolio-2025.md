...
[みずほの資料](https://www.mizuho-rt.co.jp/publication/report/2022/pdf/fe38.pdf)、「ページ 2 - 図 1」のグラフを見ると、相関係数 $ρ=0.5$ 以上では、ある程度の資産数で、分散効果が頭打ちになっていることが分かると思います。
...
執筆時点での[iFreeNEXT FANG+](https://finance.yahoo.co.jp/quote/04311181)の純資産残高は、737,952百万円（約50億ドル）。1銘柄当たり5億ドルの資産が割り当てられています。Fang+への投資信託はiFreeNEXT以外にも複数存在するため、実際には5億ドル以上の資産が1銘柄に割り当てられています。
...
この項目では[こちらのシミュレーションサイト](https://myindex.jp/myaa/guest.php)の過去20年実績を参考にしています。
...
シミュレーションサイトに、相関係数の表があります。その表から、ゴールドはほとんどの資産と相関係数が低いことを示しています。
